...
class PlayerRunState<T> : State<T>
{
    ...
    public PlayerRunState(T walkInput, T runInput, T idleInput, Action<Vector3, float> onRun, Action onShoot, float desiredSpeed, Action animation, bool showFSMTransitionInConsole)
    {
